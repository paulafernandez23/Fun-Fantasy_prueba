              ...
              <div className="flex-grow overflow-auto p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    { id: 'envios-devoluciones', title: 'Política de Envíos', icon: 'local_shipping' },
