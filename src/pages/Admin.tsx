...
function AdminContent() {
  ...
  // Cálculo de categorías para la gráfica
  ...
  // Productos más vendidos (simulado con pedidos)
            ...
            {pendingAppointments.length > 0 && (
              ...
              >
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-on-surface-variant">Haz clic para gestionarlas en la sección Citas.</p>
                </div>
        ...
        return (
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/20 shadow-sm overflow-hidden max-w-2xl">
            ...
            <div className="p-6 space-y-4">
              ...
              <div><label className="block text-xs font-bold uppercase mb-1">Descripción</label><textarea value={config.shortDescription} onChange={e => config.updateSettings({ shortDescription: e.target.value })} className="w-full bg-surface-container border border-outline-variant/30 px-3 py-2 rounded-lg outline-none text-sm h-20 resize-none"></textarea></div>
