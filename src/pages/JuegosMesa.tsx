...
export default function JuegosMesa() {
  ...
  useEffect(() => {
    ...
    // SEO
    updateMetaTags({
      title: 'Juegos de Mesa Final Fantasy - Estrategia y Rol',
      description: 'Descubre los mejores juegos de mesa y de rol de Final Fantasy. Desde el juego de tablero oficial hasta expansiones y kits de inicio épicos.',
      keywords: 'Final Fantasy Juegos de Mesa, Board Games, Juego de Rol, RPG, Estrategia Final Fantasy',
      type: 'website'
    });
  }, []);
    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      <div className="mb-16 text-center">
        ...
        <p className="text-on-surface-variant text-lg max-w-2xl mx-auto">
          Lleva la fantasía a tu mesa. Explora nuestra selección de juegos de tablero y rol oficiales de Final Fantasy.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-24 bg-surface-container-lowest rounded-[3rem] border-2 border-dashed border-outline-variant/30">
          <div className="w-24 h-24 bg-surface-container rounded-full flex items-center justify-center mx-auto mb-6">
            <span className="material-symbols-outlined text-5xl text-outline">board_game</span>
          </div>
          <h3 className="text-2xl font-bold text-on-surface mb-2">No se encontraron juegos</h3>
          <p className="text-on-surface-variant text-lg">Estamos preparando nuevas aventuras. Vuelve pronto.</p>
        </div>
      ) : (
